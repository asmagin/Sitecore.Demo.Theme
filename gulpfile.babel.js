...
gulp.task('html', ['nunjucks:configure', 'views', 'styles'], () => {
...
gulp.task('nunjucks:configure', () => {
    $.nunjucksRender.nunjucks.configure(['demo.src/'], { watch: false });
});
...
gulp.task('serve', ['nunjucks:watch', 'views', 'scripts', 'styles', 'fonts'], () => {
    browserSync({
        notify: false,
        port: 9000,
        server: {
